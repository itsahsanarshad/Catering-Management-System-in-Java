...
public class Orders_TakingNF extends javax.swing.JFrame {
...
ConnectionstoDB con =new ConnectionstoDB();
    ...
    public Orders_TakingNF() {
        initComponents();
       
    
       
        fillCombo(ls.makeListNF(con.readType("1")));
...
//    }
    ...
    private void lblsubtotalOMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblsubtotalOMouseClicked
        // TODO add your handling code here:
        String suppliesName = jComboBox1.getSelectedItem().toString();
        String price = con.readSuppliesPrice(suppliesName);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Orders_TakingNF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Orders_TakingNF().setVisible(true);
